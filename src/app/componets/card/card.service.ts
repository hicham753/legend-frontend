...
export class CardService {
   ...
   */
  public createCharge(cardToken: { id: any; }, price: any, currency: any, description: any) {
    const chargeRequest = {
      token: cardToken.id,
      price,
      description,
    ...
    return this.httpClient.post(`${environment.apiUrl}/charges`, chargeRequest, { headers: this.headers });
  }
}
